  ...
  },
{
  ...
  {
    id: "data-engineer-intermediate",
    title: "Data Engineer 중급",
    category: "offline",
    level: "advanced",
    variant: "cto",
    objectives: ["데이터 파이프라인 구축 및 최적화", "빅데이터 처리 시스템 설계 및 운영"],
    target: "데이터 엔지니어 직무 수행자",
    format: "집합",
    location: "러닝센터",
    capacity: "30",
    duration: "5일",
  ...
  },
  {
    ...
    variant: "prd",
    isSelection: true,
    objectives: ["AI 프로젝트 전문 리더 양성", "현업 문제 해결을 위한 AI 솔루션 설계 및 구현"],
    target: "AI 직무 전문가",
    format: "집합교육",
    location: "별도 안내",
    capacity: "선발",
  ...
  {
    id: "ai-scientist-advanced",
    title: "AI Scientist 고급",
    category: "offline",
    level: "expert",
    variant: "cto",
    isSelection: true,
    objectives: ["고급 머신러닝/딥러닝 알고리즘 심화", "최신 AI 연구 동향 및 응용"],
    target: "AI 직무 전문가",
    format: "집합교육",
    location: "별도 안내",
    capacity: "선발",
  ...
  {
    id: "data-engineer-advanced",
    title: "Data Engineer 고급",
    category: "offline",
    level: "expert",
    variant: "cto",
    objectives: ["대규모 데이터 아키텍처 설계", "클라우드 기반 데이터 인프라 구축"],
    target: "데이터 엔지니어 전문가",
    format: "집합교육",
    location: "별도 안내",
    capacity: "30",
